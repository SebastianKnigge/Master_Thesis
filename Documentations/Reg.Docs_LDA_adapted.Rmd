...
Now it's interesting to see if embedding via TFIDF will cluster other groups or the same. So we will reduce the Document Term Matrix to $0.8*M$ words, which amounts to a reduction by 20\%
