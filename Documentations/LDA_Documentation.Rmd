...
We now can evaluate several fits of a model for different splits. Here is a parallelization for the individual for loops applied. In this case only embeding via TF2 is used.
...
Again we try a second sample, using a different seed. 
...
This is the output of the simulation over 59 splits and fits. Consider the mean as the final result:
