...
\subsection{Reduction of the dimensionality}
...
\subsection{Apply the LDA model on the full corpus}
...
Surprisingly, the run-time to fit the LDA model for the embedding using all words, does not take way longer than the embedding using a lower frequency. The fitting of the reduced bag of words via ftidf takes even longer. Thus from here on the full embedding is used.
