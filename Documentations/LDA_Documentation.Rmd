...
The third LDA fit builds up on data from the shrinked dictionary/bag of words by *tf-idf*.
...
We now can evaluate several fits of a model for different splits. Here is a parallelization for the individual for loops applied. In this case only embeding via *tf-idf* is used.
