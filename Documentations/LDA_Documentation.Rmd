...
First we will sample the books, the same way as is was done in Example 1.
...
In the first place, we try the in-model-validation procedure, foch each of the 3 embeddings. Table \ref{in-model_val} displays the results of each validation.
