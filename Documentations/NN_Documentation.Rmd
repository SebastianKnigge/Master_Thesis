...
We also want to compare this to a reduction of the word dictionary by tfidf. We reduce to 50\% of the original size of the bag-of-words. 
...
In this step we use the embeding via *tfidf* and fit the model. The *tfidf* embedding equals a reduction by 50\%. 
